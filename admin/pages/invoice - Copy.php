...
<body>
	...
	<tr><td>
	<img src="../../assets/img/logo/logo1.png" alt="logo" width="200px">
	</td>
	<td>
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		<td style="border-right:2px solid #ccc;">'.$row['PRICE'].'</td>
	...
	$html.='</table>
	<h4 style="float:right;">Product Total&nbsp;:&nbsp;'.number_format($sub).' Taka<br>
