...
if(isset($_POST['submit']))
{
  ...
  $sub_sub_slug = slug($subcat);
  $id=intval($_GET['id']);
  $sql=mysqli_query($db,"UPDATE sub_sub_category set sub_cat_id='$category',name='$subcat',sub_sub_slug='$sub_sub_slug' where sub_sub_cat_id='$id'");
  $_SESSION['msg']="Sub Sub Category Updated !!";
...
if(!isset($_SESSION['MEMBER_ID'])){
  ...
  <script type="text/javascript">
              ...
              <div class="card shadow mb-4">
                ...
                <?php
                $id=intval($_GET['id']);
                $query=mysqli_query($db,"SELECT * from sub_sub_category,sub_category where sub_category.sub_cat_id = sub_sub_category.sub_cat_id and sub_sub_cat_id='$id'"); 
                $row_data = mysqli_fetch_assoc($query);
                $cat = $row_data['sub_cat_name'] ;
                ?>
                <div class="card-body">
                    ...
                    <table class="table table-bordered" id="" width="100%" cellspacing="0">        
                      ...
                      <tr>
                        ...
                        <td><select name="category" class="form-control" onChange="getSubcat(this.value);" style="width:400px;" required>
                          ...
                          <?php $query=mysqli_query($db,"SELECT * from sub_category");
                          while($row=mysqli_fetch_array($query))
                            {?>

                              <option value="<?php echo $row['sub_cat_id'];?>" <?php 
                              if($row['sub_cat_name']==$cat){
                                echo "selected";
                              }
                        ...
                        <tr>
                          ...
                          <td><input type="text" placeholder="Enter category Name"  name="subcategory" value="<?php echo  htmlentities($row_data['name']);?>" class="form-control" required></td>
                        </tr>
                        <tr>
                          <th></th>
