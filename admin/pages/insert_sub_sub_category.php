<?php
   ...
   if(isset($_POST['submit'])){
     ...
     $subcat_slug = slug($subcat);
   
     $sql=mysqli_query($db,"insert into sub_sub_category(sub_cat_id,name,sub_sub_slug) values('$category','$subcat','$subcat_slug')");
     $_SESSION['msg']="Sub Sub Category Created";
      ...
      <div class="card shadow mb-4">
         <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold text-primary">
               Insert Sub Sub Category&nbsp;<!-- <a  href="#" data-toggle="modal" data-target="#customerModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a> -->
            </h4>
         </div>
         <div class="card-body">
