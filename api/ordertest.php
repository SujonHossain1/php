...
$total_amount = $prod_count+$delivery;
    ...
    mysqli_query($con,"INSERT INTO orders_info(user_id,f_name,phone,email,address,city,state,zip,prod_count,product_total,delivery_charge,total_amt,comment) values('$uid','$f_name','$phone','$email','$address','$city','$state','$zip','$prod_count','$prod_total','$delivery','$total_amount','$comment') ");
$response = array();
